#include "FourierPlugin001.h"

#include <opencv2/imgproc/types_c.h>

#include "ui_plugin.h"

openCVInterface::FourierPlugin001::FourierPlugin001( ) {
...
QString openCVInterface::FourierPlugin001::title( ) {
    return this->metaObject()->className();
}

QString openCVInterface::FourierPlugin001::version( ) {
    return "1.0.0";
}

QString openCVInterface::FourierPlugin001::description( ) {
    return "A <b>Template</b> plugin";
}

QString openCVInterface::FourierPlugin001::help( ) {
    return "This is a <b>Template</b> plugin. Clone and use it to create new plugins.";
}

void openCVInterface::FourierPlugin001::setupUi( QWidget *parent ) {
    ui = new Ui::PluginGui;
    ui->setupUi(parent);
}

void openCVInterface::FourierPlugin001::processImage( const cv::Mat &inputImage, cv::Mat &outputImage ) {
    using namespace cv;
