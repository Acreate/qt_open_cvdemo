...
openCVInterface::FilterPlugin002::FilterPlugin002( ) {
...
QString openCVInterface::FilterPlugin002::title( ) {
    return this->metaObject()->className();
}

QString openCVInterface::FilterPlugin002::version( ) {
    return "1.0.0";
}

QString openCVInterface::FilterPlugin002::description( ) {
    return "Performs different filters available in OpenCV";
}

QString openCVInterface::FilterPlugin002::help( ) {
    return "This is a plugin that performs different filters available in OpenCV";
}

void openCVInterface::FilterPlugin002::setupUi( QWidget *parent ) {
    ui = new Ui::PluginGui;
    ui->setupUi(parent);
...
void openCVInterface::FilterPlugin002::processImage( const cv::Mat &inputImage, cv::Mat &outputImage ) {
    using namespace cv;
    Matx33f f2dkernel;
...
void openCVInterface::FilterPlugin002::on_bilateralDiaSpin_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_bilateralSigmaColorSpin_valueChanged( double arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_bilateralSigmaSpaceSpin_valueChanged( double arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_blurKernelSizeSpinBox_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_blurAnchoXSpin_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_blurAnchoYSpin_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_boxKernelSizeSpinBox_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_boxDepthSpin_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_boxAnchoXSpin_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_boxAnchoYSpin_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_boxNormalCheck_toggled( bool checked ) {
    Q_UNUSED(checked);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_gaussKernelSizeSpinBox_valueChanged( int arg1 ) {
    if( arg1 % 2 == 1 )// Must be odd
        emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_gaussSigmaXSpin_valueChanged( double arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_gaussSigmaYSpin_valueChanged( double arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_medianApertureSpin_valueChanged( int arg1 ) {
    if( arg1 % 2 == 1 )// Must be odd
        emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_mainTabs_currentChanged( int index ) {
    Q_UNUSED(index);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_derivSobelRadio_toggled( bool checked ) {
    Q_UNUSED(checked);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_derivScharrRadio_toggled( bool checked ) {
    Q_UNUSED(checked);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_derivLaplacRadio_toggled( bool checked ) {
    Q_UNUSED(checked);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_derivScaleSpin_valueChanged( double arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_derivDeltaSpin_valueChanged( double arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_morphErodeRadio_toggled( bool checked ) {
    Q_UNUSED(checked);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_morphDilateRadio_toggled( bool checked ) {
    Q_UNUSED(checked);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_morphMorphRadio_toggled( bool checked ) {
    Q_UNUSED(checked);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_morphIterSpin_valueChanged( int arg1 ) {
    Q_UNUSED(arg1);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_morphTypesCombo_currentIndexChanged( int index ) {
    Q_UNUSED(index);
    emit updateNeeded();
}

void openCVInterface::FilterPlugin002::on_morphShapesCombo_currentIndexChanged( int index ) {
    Q_UNUSED(index);
    emit updateNeeded();
}